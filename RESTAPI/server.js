...
function sayHello(keyword) {
    axios.get(`http:/${functionIP}:${functionPort}/hello/?keyword=${keyword}`)
        .then(res => {
...
let swaggerDocument = {
 ...
 "/say?keyword={keyword}": {
            "get": {
                ...
                "summary": "Say hello",
                "description": "This will be the Gateway for the Web Fuction created in Azure",
...
app.get('/say',  (req, res) => {
    ...
    try{
        ...
        const response  =  axios.get(`${url}/?keyword=${keyword}`).then((response) => {
